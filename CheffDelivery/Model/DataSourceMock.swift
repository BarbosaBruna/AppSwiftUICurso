...
//  CheffDelivery
//
//  Created by Bruna Aparecida on 19/09/23.
//
...
let ordersMock: [OrderType] = [
    ...
    OrderType(id: 4, name: "Pets", image: "petshop"),
    OrderType(id: 5, name: "Descontos", image: "descontos"),
    OrderType(id: 6, name: "Bebidas", image: "bebidas"),
    OrderType(id: 7, name: "Goumert", image: "gourmet"),
]

let storesMock: [OrderType] = [
    OrderType(id: 1, name: "Monstro Buger", image: "monstro-burger-logo"),
